...
//   size: string;
//   price: number;
//   model3D?: string; // URL or import of 3D model
//   image?: string;
// }
...
// export default function Neon3DProductPage({ product, relatedProducts = [] }: Props) {
...
//   const name = lang === "en" ? product.name_en : product.name_bn;
//   const description = lang === "en" ? product.description_en : product.description_bn;
...
//     else cart.push({ id: product.id, name, variant: selectedVariant, quantity });
...
//     <>
//       <Head>
//         <title>{name} | NeonShop</title>
//         <meta name="description" content={description} />
//         <meta property="og:title" content={name} />
//         <meta property="og:description" content={description} />
//         <meta property="og:image" content={selectedVariant?.image || "/placeholder.png"} />
//       </Head>

//       {/* Language Toggle */}
//       <div className="max-w-6xl mx-auto p-4 flex justify-end gap-2">
//         <button
//           onClick={() => setLang("en")}
...
//         <button
//           onClick={() => setLang("bn")}
//           className={`px-3 py-1 rounded ${lang === "bn" ? "bg-blue-600 text-white" : "bg-gray-200"}`}
//         >
//           BN
//         </button>
//       </div>
...
//         {/* 3D Product */}
//         <motion.div
//           className="md:w-1/2 w-full h-[400px] md:h-[600px] rounded-lg overflow-hidden bg-black"
//           initial={{ opacity: 0 }}
//           animate={{ opacity: 1 }}
//         >
...
//               {/* Neon glowing object */}
//               <mesh>
//                 <torusKnotGeometry args={[0.8, 0.2, 128, 64]} />
...
//           <p className="text-2xl text-green-500 font-semibold">৳ {selectedVariant?.price || 0}</p>
...
//                 <button
//                   key={i}
//                   className={`px-3 py-1 border rounded ${selectedVariant?.color === v.color ? "bg-blue-600 text-white" : "bg-gray-200"}`}
...
//             <button onClick={() => setQuantity(q => Math.max(1, q - 1))} className="px-3 py-1 bg-gray-200 rounded hover:bg-gray-300">-</button>
//             <span className="text-lg">{quantity}</span>
//             <button onClick={() => setQuantity(q => q + 1)} className="px-3 py-1 bg-gray-200 rounded hover:bg-gray-300">+</button>
//           </div>
...
//             onClick={addToCart}
//             whileTap={{ scale: 0.95 }}
//             className="mt-4 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition w-full md:w-auto sticky top-5"
//           >
//             Add to Cart
//           </motion.button>
//         </motion.div>
...
// // export default function SEOProductPage({ product }: Props) {
// //   if (!product) {
// //     return <div className="w-full h-screen flex items-center justify-center text-lg">Loading Product...____________.....</div>;
// //   }
